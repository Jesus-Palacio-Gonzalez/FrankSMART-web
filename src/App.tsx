      ...
      <div className="relative z-10 flex h-full flex-col overflow-y-auto">
        ...
        <div className="flex flex-1 shrink-0 flex-col justify-center px-6 py-6 sm:px-10 lg:px-16">
          ...
          <div className="mt-6 flex animate-fade-up-delay-3 flex-wrap items-center gap-4 sm:gap-6 lg:mt-8">
            <button className="group flex items-center gap-2 bg-accent px-5 py-3 font-inter text-[11px] font-semibold uppercase tracking-widest text-background shadow-glow-sm transition hover:shadow-glow sm:px-7 sm:py-4 sm:text-xs">
